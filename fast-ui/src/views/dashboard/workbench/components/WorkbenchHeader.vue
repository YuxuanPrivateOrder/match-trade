  ...
  <div class="lg:flex">
    ...
    <div class="flex flex-1 justify-end md:mt-0 mt-4">
      <div class="flex flex-col justify-center text-right">
        ...
        <span class="text-2xl"><CountTo prefix="" :startVal="1" :endVal="195051254454" /></span>
      </div>

      <div class="flex flex-col justify-center text-right md:mx-16 mx-12">
        <span class="text-secondary"> PAP </span>
        <span class="text-2xl">35.0</span>
      </div>
      ...
      <div class="flex flex-col justify-center text-right md:mr-10 mr-4">
        ...
        <span class="text-2xl"><CountTo prefix="" :startVal="1" :endVal="254698432" /></span>
      </div>
    </div>
  </div>
</template>
