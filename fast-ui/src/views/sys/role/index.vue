<template>
  <PageWrapper dense contentFullHeight contentClass="flex">
    <BasicTable @register="registerTable" class="w-5/6 xl:w-5/6" @query-reset-func="restFun"
    ...
    <Card class="w-1/6 xl:w-1/6" style="margin: 16px">
      <template #title>
        ...
        <a-button class="distribution" v-auth="['role:edit']" size="small" type="primary"
                  :disabled="!showButton" @click="saveMenuFun" preIcon="ant-design:check-outlined">
          保存
        </a-button>
      </template>
      <BasicTree
